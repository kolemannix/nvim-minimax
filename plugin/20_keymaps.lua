...
-- Execute lua
nmap_leader('hx', ':.lua<cr>', 'e[x]ecute line lua')
...
nmap('-', explore_at_file, 'Files at buffer')
...
nmap('gd', "<Cmd>lua vim.lsp.definition()", '[g]o [d]efinition')
local diags_to_qflist = function()
  vim.fn.setqflist({}, 'r', { title = "Diagnostics" })
  vim.diagnostic.setqflist({ severity = { min = vim.diagnostic.severity.WARN } })
end
nmap_leader("le", diags_to_qflist, '[l]anguage [e]rrors')
...
-- t is for 'Terminal'
nmap_leader('ts', '<Cmd>horizontal term<CR>', 'Terminal (horizontal)')
